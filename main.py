...
path = 'serious.mp4'
video_capture = cv2.VideoCapture(0)  # changing paths
...
while True:
    ...
    if count % 5 != 0:
        ...
        indices = processing.non_max_suppression(
        ...
        for track in tracker.tracks:
            ...
            # If not violent previously
            if not labels[track.track_id] and 'person_'+str(track.track_id) in person_TS.keys():
